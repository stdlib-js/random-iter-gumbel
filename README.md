...
```javascript
iterator = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/random-iter-gumbel@umd/browser.js' )
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/random-iter-gumbel/tags). For example,

```javascript
iterator = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/random-iter-gumbel@v0.2.2-umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var iterator = require( 'path/to/vendor/umd/random-iter-gumbel/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/random-iter-gumbel@umd/browser.js"></script>
```
...
[npm-image]: http://img.shields.io/npm/v/@stdlib/random-iter-gumbel.svg
[npm-url]: https://npmjs.org/package/@stdlib/random-iter-gumbel

[test-image]: https://github.com/stdlib-js/random-iter-gumbel/actions/workflows/test.yml/badge.svg?branch=v0.2.2
[test-url]: https://github.com/stdlib-js/random-iter-gumbel/actions/workflows/test.yml?query=branch:v0.2.2

[coverage-image]: https://img.shields.io/codecov/c/github/stdlib-js/random-iter-gumbel/main.svg
[coverage-url]: https://codecov.io/github/stdlib-js/random-iter-gumbel?branch=main

<!--

[dependencies-image]: https://img.shields.io/david/stdlib-js/random-iter-gumbel.svg
[dependencies-url]: https://david-dm.org/stdlib-js/random-iter-gumbel/main
...
[deno-url]: https://github.com/stdlib-js/random-iter-gumbel/tree/deno
[deno-readme]: https://github.com/stdlib-js/random-iter-gumbel/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/random-iter-gumbel/tree/umd
[umd-readme]: https://github.com/stdlib-js/random-iter-gumbel/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/random-iter-gumbel/tree/esm
[esm-readme]: https://github.com/stdlib-js/random-iter-gumbel/blob/esm/README.md
[branches-url]: https://github.com/stdlib-js/random-iter-gumbel/blob/main/branches.md

[stdlib-license]: https://raw.githubusercontent.com/stdlib-js/random-iter-gumbel/main/LICENSE
