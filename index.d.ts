...
/**
* Interface for iterators of pseudorandom numbers drawn from a Gumbel distribution.
*/
...
* // ...
*/
declare function iterator( mu: number, beta: number, options?: Options ): RandIter; // tslint:disable-line:max-line-length
