...
tape( 'the function throws an error if mean `mu` is not a number primitive', function test( t ) {
	var values;
	var i;
...
tape( 'the function throws an error if scale parameter `beta` is not a positive number', function test( t ) {
	var values;
	var i;
...
tape( 'the function returns an iterator protocol-compliant object (seed)', function test( t ) {
	...
	it1 = iterator( 0.0, 4.0, {
		'seed': seed
	});
	it2 = iterator( 0.0, 4.0, {
		'seed': seed
	});
...
tape( 'the function returns an iterator for generating pseudorandom numbers from a Gumbel distribution', function test( t ) {
	var rand;
	var it;
	var i;
